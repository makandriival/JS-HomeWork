...
let theList = document.querySelectorAll(".item");
console.log(`there is '+ ${theList.length} + ' categories`);


theList.forEach(elem => {
    let h2Title = elem.querySelector('h2').innerText;
    let lis = elem.querySelectorAll('li').length; 
